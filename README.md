...
Automate your code reviews using OpenAI's GPT models to ensure TypeScript code adheres to best practices, focusing on exposed secrets, performance optimizations, code readability, and clean code principles.

## Overview
`gpt-review-action` leverages OpenAI's GPT models (e.g., GPT-4, GPT-4o) to analyze Git diffs in your TypeScript repositories. The action automatically generates insightful feedback on your pull requests, helping teams maintain clean, performant, and secure code.
...
| `openai-api-key`      | ✅       | Your OpenAI API key for GPT model access.                                   |
...
1. **OpenAI API Key**: Obtain a valid API key for GPT models.
2. **GitHub Secrets**:
...
- **Outputs**: Comments on pull requests with actionable insights generated by GPT models.
